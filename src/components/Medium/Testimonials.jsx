...
export const Testimonials = () => {
  return (
    <div className="bg-black z-10 w-full h-fit flex items-center justify-center  flex-col">
      ...
      <div className="w-[80%] mt-10 md:w-[80%] md:h-fit  flex-col md:flex-row rounded-3xl flex gap-4">
        <div className="md:w-[33%]  md:h-full h-fit w-full gap-5 flex flex-col">
          <div className="w-full p-5 h-fit bg-black border-[1px] border-zinc-900 rounded-xl">
            <div>
            ...
            <div className="w-[90%] h-[1px] mt-3 bg-gradient-to-r to-black from-blue-300 "></div>
        ...
        <div className="md:w-[33%] md:h-full h-fit w-full gap-5 flex flex-col">
          <div className="w-full p-5 h-fit bg-black border-[1px] border-zinc-900 font rounded-xl">
            <div>
