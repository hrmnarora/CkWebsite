...
export const Testimonials = () => {
  return (
    <div className="bg-zinc-950 z-10 w-full h-fit flex items-center justify-center  flex-col">
      <div className="courses pt-32 bg-zinc-950 w-[80%] z-10  flex lg:justify-center flex-col  h-fit lg:flex-col">
        <SubHeading
          type={"Testimonials"}
