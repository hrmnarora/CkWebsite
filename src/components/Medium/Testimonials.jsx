        ...
        <div className="md:w-[33%]  md:h-full h-fit w-full gap-5 flex flex-col">
          <div className="w-full p-5 h-fit bg-zinc-950 border-[1px] border-zinc-900 rounded-xl">
            ...
            <div className="mt-5 flex gap-3">
              ...
              <div className="flx flex-col gap-1">
                <h3 className="text-white text-xl font-bold">Abhishek Bajpayee</h3>
                <p>Student</p>
              </div>
            </div>
          </div>
          <div className="w-full p-5 h-fit bg-zinc-950 border-[1px] border-zinc-900 rounded-xl">
            ...
            <div className="mt-5 flex gap-3">
              ...
              <div className="flx flex-col gap-1">
                <h3 className="text-white text-xl font-bold">Bhanu Pratap Singh Rathore</h3>
                <p>Student</p>
              </div>
            </div>
          </div>
        ...
        <div className="md:w-[33%] md:h-full h-fit w-full gap-5 flex flex-col">
          <div className="w-full p-5 h-fit bg-zinc-950 border-[1px] border-zinc-900 font rounded-xl">
            ...
            <div className="mt-5 flex gap-3">
              ...
              <div className="flx flex-col gap-1">
                <h3 className="text-white text-xl font-bold">Vipul Reddy</h3>
                <p>Student</p>
              </div>
            </div>
          </div>
          <div className="w-full p-5 h-fit bg-zinc-950 border-[1px] border-zinc-900 rounded-xl">
            ...
            <div className="mt-5 flex gap-3">
              ...
              <div className="flx flex-col gap-1">
                <h3 className="text-white text-xl font-bold">Akash Sharma</h3>
                <p>Student</p>
              </div>
            </div>
          </div>
        ...
        <div className="md:w-[33%]  md:h-full h-fit w-full gap-5 flex flex-col">
          <div className="w-full p-5 h-fit bg-zinc-950 border-[1px] border-zinc-900 rounded-xl">
            ...
            <div className="mt-5 flex gap-3">
              ...
              <div className="flx flex-col gap-1">
                <h3 className="text-white text-xl font-bold">Saurav Gupta</h3>
                <p>Student</p>
              </div>
            </div>
          </div>
          <div className="w-full p-5 h-fit bg-zinc-950 border-[1px] border-zinc-900 rounded-xl">
            ...
            <div className="mt-5 flex gap-3">
              ...
              <div className="flx flex-col gap-1">
                <h3 className="text-white text-xl font-bold">Vinay Prajapati</h3>
                <p>Student</p>
              </div>
            </div>
          </div>
